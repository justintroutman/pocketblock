...
\input{auto_calc_initial.tex} % generates six random numbers to seed key scheduler; default; comment out to turn off

%% \input{manual_calc_initial.tex} % user defines six desired numbers to seed key scheduler; uncomment to turn on
