...
\node[nodetext] at (0.5,5.5) {7};
\node[nodetext] at (1.5,5.5) {3};
\node[nodetext] at (2.5,5.5) {5};
\node[nodetext] at (3.5,5.5) {7};
\node[nodetext] at (4.5,5.5) {9};
\node[nodetext] at (5.5,5.5) {1};

\node[nodetext] at (0.5,4.5) {0};
\node[nodetext] at (1.5,4.5) {8};
\node[nodetext] at (2.5,4.5) {2};
\node[nodetext] at (3.5,4.5) {6};
\node[nodetext] at (4.5,4.5) {0};
\node[nodetext] at (5.5,4.5) {8};

\node[nodetext] at (0.5,3.5) {8};
\node[nodetext] at (1.5,3.5) {0};
\node[nodetext] at (2.5,3.5) {8};
\node[nodetext] at (3.5,3.5) {6};
\node[nodetext] at (4.5,3.5) {8};
\node[nodetext] at (5.5,3.5) {8};

\node[nodetext] at (0.5,2.5) {8};
\node[nodetext] at (1.5,2.5) {8};
\node[nodetext] at (2.5,2.5) {4};
\node[nodetext] at (3.5,2.5) {4};
\node[nodetext] at (4.5,2.5) {6};
\node[nodetext] at (5.5,2.5) {6};

\node[nodetext] at (0.5,1.5) {6};
\node[nodetext] at (1.5,1.5) {2};
\node[nodetext] at (2.5,1.5) {8};
\node[nodetext] at (3.5,1.5) {0};
\node[nodetext] at (4.5,1.5) {2};
\node[nodetext] at (5.5,1.5) {4};

\node[nodetext] at (0.5,0.5) {8};
\node[nodetext] at (1.5,0.5) {0};
\node[nodetext] at (2.5,0.5) {8};
\node[nodetext] at (3.5,0.5) {2};
\node[nodetext] at (4.5,0.5) {6};
\node[nodetext] at (5.5,0.5) {0};

%% set coordinates for lookups

\node[coord] at (0.5,6.7) {A}; %% top row, first (leftmost)
\node[coord] at (1.5,6.7) {E}; %% top row, second
\node[coord] at (2.5,6.7) {I}; %% top row, third
\node[coord] at (3.5,6.7) {O}; %% top row, fourth
\node[coord] at (4.5,6.7) {U}; %% top row, fifth
\node[coord] at (5.5,6.7) {Y}; %% top row, sixth (rightmost)

\node[coord] at (-0.7,5.5) {A}; %% left side, first (top)
\node[coord] at (-0.7,4.5) {E}; %% left side, second
\node[coord] at (-0.7,3.5) {I}; %% left side, third
\node[coord] at (-0.7,2.5) {O}; %% left side, fourth
\node[coord] at (-0.7,1.5) {U}; %% left side, fifth
\node[coord] at (-0.7,0.5) {Y}; %% left side, sixth (bottom)
